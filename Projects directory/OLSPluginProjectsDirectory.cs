...
namespace OpenLabStudio.plugins
{
    public class OLSPluginProjectsDirectory : ProjectStorage
    {
        ...
        internal class Info : IPluginInfo
        {
            ...
            public string Title { get; } = "OpenLab Studio projects sorage directory";
            ...
            public string description { get; } = "Load OpenLab Studio projects from a local directory";
        }
        ...
        {
            log.info($"Deinit project storage {pluginInfo.Title} ({pluginInfo.Name})");
            return 0;
        }
